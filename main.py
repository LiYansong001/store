...
print("--------------------------------------------------------")
print("总销售额：",round(253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140+86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+65.8*63+96.8*78,2))
print("平均销售量:",round((10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)/30,2))
print("--------------------------------------------------------")
print("羽绒服本月销售占比：",round((10+69+140+10+10)/500*100,2),"%")
print("牛仔裤本月销售占比：",round((60+72+35+90+60+60+140)/600*100,2),"%")
print("风衣本月销售占比：",round((43+25+43+60+43+78)/335*100,2),"%")
print("皮草服本月销售占比：",round((63+24+63+57)/855*100,2),"%")
print("T恤服本月销售占比：",round((63+45+129+63+58+48+63)/632*100,2),"%")
print("衬衫服本月销售占比：",round(120/562*100,2),"%")
print("--------------------------------------------------------")
